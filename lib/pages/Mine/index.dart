...
import 'package:hm_shop/components/Mine/HmGusee.dart';
...
class _MineViewState extends State<MineView> {
  final Usercontroller _userConstroller = Get.put(Usercontroller());
          ...
          Obx(() {
            return CircleAvatar(
              ...
              backgroundImage: _userConstroller.user.value.avatar.isNotEmpty
                  ...
                  : AssetImage('lib/assets/tab/goods_avatar.png'),
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            Image.asset(
              "lib/assets/tab/ic_user_vip.png",
              width: 30,
              height: 30,
            ),
            SizedBox(width: 10),
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            item("lib/assets/tab/ic_user_collect.png", '我的收藏'),
            item("lib/assets/tab/ic_user_history.png", '我的足迹'),
            item("lib/assets/tab/ic_user_unevaluated.png", '我的客服'),
          ],
        ),
      ),
    );
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceAround,
                children: [
                  orderItem("lib/assets/tab/ic_user_order.png", '全部订单'),
                  orderItem("lib/assets/tab/ic_user_obligation.png", '待付款'),
                  orderItem("lib/assets/tab/ic_user_unreceived.png", '待发货'),
                  orderItem("lib/assets/tab/ic_user_unshipped.png", '待收货'),
                  orderItem("lib/assets/tab/ic_user_unevaluated.png", '待评价'),
                ],
              ),
            ],
          ),
  ...
  Widget build(BuildContext context) {
    return CustomScrollView(
      ...
      slivers: [
        ...
        SliverPersistentHeader(delegate: Hmgusee(), pinned: true),
